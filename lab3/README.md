...
## Висновок:
У результаті виконання лабораторної роботи було розроблено кросплатформний застосунок на базі React Native та Expo Router, у якому реалізовано комплексну обробку жестів та плавних анімацій. Завдяки використанню Gesture Handler та Reanimated, вдалося досягти нативної взаємодії користувача з інтерфейсом (Pinch, Pan, Exclusive Taps), а впровадження Context API та власних UI-компонентів (AppView, AppText) забезпечило стабільне керування станом і темами проєкту. Робота дозволила практично опанувати принципи декларативної анімації, типізації через TypeScript та створення гнучкої архітектури для сучасних мобільних додатків.
